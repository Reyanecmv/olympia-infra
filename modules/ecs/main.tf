...
resource "aws_lb_target_group" "app" {
  ...
  # Slow start gives the application time to warm up
  slow_start = 60

  # Enable stickiness for session management if needed
  stickiness {
    enabled         = true
    type            = "lb_cookie"
...
resource "aws_cloudwatch_metric_alarm" "cpu_high" {
  ...
  alarm_description = "This metric monitors high ECS service CPU utilization"
...
resource "aws_cloudwatch_metric_alarm" "memory_high" {
  ...
  alarm_description = "This metric monitors high ECS service memory utilization"
  alarm_actions     = [aws_sns_topic.alarms.arn]
}
